...
type Syscheck struct {
	...
	InodeAfter   *StrUInt       `json:"inode_after,omitempty" opensearch:"keyword"`
	InodeBefore  *StrUInt       `json:"inode_before,omitempty" opensearch:"keyword"`
...
type File struct {
	Inode *StrUInt `json:"inode,omitempty" opensearch:"keyword"`
	Mode  *string  `json:"mode,omitempty" opensearch:"keyword"`
	Name  *string  `json:"name,omitempty" opensearch:"keyword"`
}
...
type Port struct {
	...
	TxQueue    *StrUInt `json:"tx_queue,omitempty" opensearch:"long"`
	Inode      *StrUInt `json:"inode,omitempty" opensearch:"long"`
	State      *string  `json:"state,omitempty" opensearch:"keyword"`
	Pid        *StrUInt `json:"pid,omitempty" opensearch:"long"`
	Process    *string  `json:"process,omitempty" opensearch:"keyword"`
	LocalPort  *StrUInt `json:"local_port,omitempty" opensearch:"long"`
	LocalIp    *string  `json:"local_ip,omitempty" opensearch:"keyword"`
	RemotePort *StrUInt `json:"remote_port,omitempty"`
	RxQueue    *StrUInt `json:"rx_queue,omitempty" opensearch:"long"`
...
type Program struct {
	...
	Size         *StrUInt `json:"size,omitempty" opensearch:"long"`
